    ...
    <div className="font-sans text-white overflow-x-hidden bg-charcoal">
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-medium tracking-widest uppercase opacity-90">
            <a href="#about" className="hover:text-ember-500 transition-colors">
              Cerita
            </a>
            <a
              href="#timeline"
            ...
            <a href="#grill" className="hover:text-ember-500 transition-colors">
              Dapur
            </a>
            <a href="#staff" className="hover:text-ember-500 transition-colors">
              Keluarga
            </a>
            <a
              href="#location"
      ...
      >
        <div className="max-w-4xl mx-auto flex flex-col items-center pt-20">
          ...
          <FadeIn delay={200}>
            <div className="h-1 w-24 bg-ember-600 mb-8 mx-auto rounded-full shadow-lg">
            </div>
      ...
      <section
        id="about"
        className="min-h-screen md:h-screen flex items-center bg-[#500302] text-white relative z-20 shadow-2xl -mt-1 overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <FadeIn className="order-2 md:order-1">
              <div className="relative group max-w-md md:max-w-full mx-auto">
                <div className="absolute -inset-2 border border-ember-900/50 transform translate-x-1 translate-y-1 z-0 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500">
                </div>
                <img
                  src="https://s3.c-app.net/kalianak-media/web_frontend/images/about/about.png"
                  alt="Ibu cooking"
            ...
            <div className="space-y-4 md:space-y-6 order-1 md:order-2">
              <FadeIn delay={200}>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span className="uppercase tracking-[0.2em] text-[10px] md:text-xs text-ember-200 font-semibold">
                    Tentang Kami
                  </span>
                </div>
              ...
              <FadeIn delay={600}>
                <div className="pt-4 md:pt-6 border-t border-white/20">
                  <p className="font-serif text-xl md:text-2xl italic text-ember-300">
                    "Dari hati, untuk rasa."
                  </p>
                </div>
              </FadeIn>
            </div>
      ...
      <ParallaxSection
        imageUrl="https://s3.c-app.net/kalianak-media/web_frontend/images/section_3/section_3_bg.jpeg"
      ...
      <section
        id="timeline"
        className="py-24 bg-gradient-to-b from-charcoal to-black relative z-20 shadow-2xl"
      >
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-16">
            <span className="uppercase tracking-[0.2em] text-sm text-ember-500 font-bold block mb-2">
              Sejak 1998
            </span>
      ...
      <ParallaxSection
        id="grill"
        imageUrl="https://s3.c-app.net/kalianak-media/web_frontend/images/section_5/section_5_bg.jpeg"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <FadeIn className="text-left md:order-1">
            <div className="inline-block bg-ember-600/20 px-4 py-2 rounded-full border border-ember-600/30 mb-6 backdrop-blur-sm">
              <span className="text-ember-500 font-bold uppercase tracking-widest text-xs">
                The Soul of Cooking
              </span>
            </div>
            <h2 className="font-serif text-5xl md:text-7xl font-bold mb-8 leading-none drop-shadow-lg">
              {GRILL_CONTENT.title}
            </h2>
            <div className="space-y-6 text-gray-200 text-lg md:text-xl font-light drop-shadow-md">
              {GRILL_CONTENT.paragraphs.map((p, i) => <p key={i}>{p}</p>)}
            </div>
          </FadeIn>
          <div className="md:order-2 flex justify-center items-center">
            <div className="relative w-64 h-64 md:w-96 md:h-96">
              <div className="absolute inset-0 border-4 border-ember-500/30 rounded-full animate-[spin_10s_linear_infinite]">
              </div>
        ...
        <div className="w-screen max-w-full">
          <div className="container mx-auto px-6 mb-4 md:mb-10">
            <FadeIn className="text-center">
              <h2 className="font-serif text-5xl md:text-9xl font-bold mb-2 text-white uppercase tracking-tighter leading-none">
                {STAFF_CONTENT.title}
              </h2>
              <p className="text-gray-400 text-sm md:text-2xl font-light max-w-3xl mx-auto">
                {STAFF_CONTENT.subtitle}
              </p>
            </FadeIn>
          </div>
      ...
      >
        <div className="container mx-auto px-6 text-center">
          <FadeIn>
            <span className="uppercase tracking-[0.3em] text-ember-500 font-bold text-[10px] md:text-sm block mb-2">
              Let's Connect
            </span>
            <h2 className="font-serif text-3xl md:text-7xl lg:text-9xl font-bold mb-4 text-white leading-tight">
              Follow the Flavor
            </h2>
            <a
              href={`https://instagram.com/${
                SOCIAL_CONTENT.handle.replace("@", "")
              }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-12 text-center items-start max-w-6xl mx-auto border-y border-white/5 py-6 md:py-12">
            <FadeIn delay={100}>
              <div className="flex flex-col items-center">
                ...
                <h3 className="uppercase tracking-widest text-[9px] font-bold text-white/40 mb-1">
                  Lokasi
                </h3>
                <p className="text-gray-300 text-[10px] md:text-base leading-snug">
        ...
        <div className="container mx-auto px-6 text-center">
          <FadeIn delay={400}>
            <div className="flex justify-center gap-4 md:gap-8 mb-4 md:mb-10">
              ...
              <SocialIcon href="#">
                <div className="font-bold text-sm md:text-lg px-1">Tk</div>
              </SocialIcon>
            </div>
